...
public class ExampleUserDetails extends SocialUser {
	...
	private static final long serialVersionUID = 505641388335042888L;
	...
	public String toString() {
		return new ToStringBuilder(this).append("id", id).append("username", getUsername()).append("firstName", firstName).append("lastName", lastName)
				.append("role", role).append("socialSignInProvider", socialSignInProvider).toString();
	}
