	...
	/ -------------------------------------------------------------------------------- */	
		...
		if (jQuery().goMap && google && google.maps) {
			 $headerMap.each(function(index, element) {
				var map=$(this).goMap({ 
					markers : [{ 
						address : 'Potosí 10, Madrid', /* change your adress here */
						title : 'Basañez y Mercader S.L.\nCalle Potosí 10, 3ºD\n28016, Madrid', /* title information */
						icon : {
							image : 'assets/images/misc/pin_red.png' /* your custom icon file */
						},
						html: { 
							content: "<div style='font-size:12px'>Basañez y Mercader S.L.<br/>Calle Potosí 10, 3ºD<br/>28016, Madrid</div>", 
							popup:true 
						}
					}], 
					scrollwheel : true,
